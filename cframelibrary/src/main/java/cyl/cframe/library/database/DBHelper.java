package cyl.cframe.library.database;
...
import cyl.cframe.library.database.exception.DbException;
import cyl.cframe.library.database.sqlite.CursorUtils;
import cyl.cframe.library.database.sqlite.SqlBuilder;
import cyl.cframe.library.database.sqlite.SqlInfo;
import cyl.cframe.library.database.table.TableInfo;
import cyl.cframe.library.database.utils.ClassUtils;
...
public class DBHelper {
     ...
     * 记录数据更新时间
     *
     * @author Dallas.Cao </br> Create at 2014/5/26
     * @version 1.0
     */
    @Table(name = "t_update")
